...
<td>
    ...
    <a href="formEditarProductos.php?id=<?php echo($row_rs_producto['id']);?>"><input type="button" name="" value="Editar"> </a>
<a href=" ../../login1/usuario/eliminar1.php?id=<?php echo($row_rs_producto['id_pedidos']);?>"><input type="button" name="" value="Eliminar"> 
    </a>
 </td>
