...
<body>
    ...
    <tbody>
      <tr>
        ...
        <p>Un color blanco con tonos amarillentos y una corteza blanda,</p></p><p> <strong>Peso:</strong>
            aprox. 9000 g.</p></td>
        <td>
        ...
        <td> <input   type="submit" class="btn btn-primary" value="Agregar" onclick="return confirmar()"> </td></form>
        <script>
function confirmar()
{
