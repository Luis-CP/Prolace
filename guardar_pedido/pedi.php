...
echo "vairable es :$nombre ____$apellido";
$mysqli = new mysqli("localhost", "root", "", "p1");
$sql = "SELECT COUNT(*) total FROM usuarios where id='$apellido'";
...
<table class="table table-bordered">
	<thead>
	  <tr>
		...
		<th class="p-3 mb-2 bg-primary text-white" scope="col">Precio</thclass="p-3 mb-2 bg-primary text-white">
	  </tr>
	</thead>
	<tbody>
	  <tr>
		...
		<p>Un color blanco con tonos amarillentos y una corteza blanda,</p></p><p> <strong>Presentación:</strong>
			aprox. 1,5 kg.</p></td>
		<td>
			<input class="form-control" id="exampleFormControlInput1" type="text" name=" id_usuario">
