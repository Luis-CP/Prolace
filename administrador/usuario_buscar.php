<?php
	...
	if(!empty($_POST))
	{
		$valor1 = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE id_usuario LIKE '%$valor1'";
		}
	}
	$sql = "SELECT * FROM usuario $where1";
...
<?php if($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
    ...
    <div class="product-status-wrap">			   
                <?php echo"<center>"; echo'<p class="p-3 mb-2 bg-white text-dark">'; echo "Has buscado  la clave:";echo'<strong>'.$valor1; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Usuario econtrado'; echo'</strong></p>';  echo"</center>"; ?>
           </div>
           <?php }else{

echo"<center>"; echo '<p class="p-3 mb-2 bg-white text-dark">Has buscado  la clave: ';echo'<strong>'.$valor1; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Usuario no encontrado'; echo'</strong></p></div>';echo"<center>";
           }?>
    </div>
