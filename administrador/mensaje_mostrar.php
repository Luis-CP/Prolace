...
do {
    ?>                              <tr>
                                <td><?php echo $row_rs_producto['id_mensaje'];?></td>
...
<td><?php echo $row_rs_producto['fechaDepeticion']; ?></td>
                                    ...
                                    <td>
                                        <button data-toggle="tooltip" title="Editar mensaje" class="pd-setting-ed"><a href="../administrador/mensaje_editar.php?id=<?php echo($row_rs_producto['id_mensaje']);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>editar</button>
                                        <button data-toggle="tooltip" title="Eliminar" class="pd-setting-ed"><a href="../contactos/procesos/eliminar1.php?id=<?php echo($row_rs_producto['id_mensaje']);?>"> <i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                    </td>
                                </tr>
                                </tr>
                                <?php
