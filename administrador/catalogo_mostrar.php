...
if(!empty($_POST))
{
    ...
    if(!empty($valor)){
        $where = "WHERE id_catalogo LIKE '%$valor6'";
     
    }
}
$sql1 = "SELECT * FROM catalogo_producto $where";
...
<?php if($row = $resultado1->fetch_array(MYSQLI_ASSOC)) { ?>
				
    <div class="product-status-wrap">			   
                <?php echo"<center>"; echo'<p class="p-3 mb-2 bg-white text-dark">'; echo "Has buscado  la clave:";echo'<strong>'.$valor6; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Catologo  de producto   encontrado'; echo'</strong></p>';  echo"</center>"; ?>
           </div>
           <?php }else{

echo"<center>"; echo '<p class="p-3 mb-2 bg-white text-dark">Has buscado  la clave: ';echo'<strong>'.$valor6; echo'</strong></p>
                   <p class="p-3 mb-2 bg-white text-dark"><strong>';echo 'Catalogo  de producto no encontrado'; echo'</strong></p></div>';echo"<center>";
           }?>
    </div>
      ...
      <table class="table table-bordered" >
					...
					<?php 
						 while($row = $resultado1->fetch_array(MYSQLI_ASSOC)) { ?>
                               ...
                               <td><?php echo '<img src="'.$row['ruta'].'" width="200px" height="200px">'; ?></td> 
                                

                                
                                
                                <td><a href="postulante.php?id=<?php echo $row['id_catalogo']; ?>"><span class="glyphicon glyphicon-pencil"></span>Modificar</a></td>
                                <td><a   href="eliminar2.php?id=<?php echo $row['id_catalogo']; ?>"   data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span>Eliminar</a></td>
