                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Editar mensaje</a></li>
                                </ul>
...
$query_rs_producto=sprintf("Select * from   catalogo_producto where id_catalogo='%s'",$_GET['id']);
...
?>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" value="<?php echo ($row_rs_producto['nombre_producto']);?>" class="form-control" name="nombre_producto" placeholder="Nombre del mensaje: ejemplo@yahoo.com">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="text" value="<?php echo ($row_rs_producto['tipo_producto']);?>"class="form-control" name="tipo_producto" placeholder="Asunto del mensaje">
                                                    </div>
                                               
                                                  <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="number" value="<?php echo ($row_rs_producto['descripcion_producto']);?>"class="form-control" name="descripcion_producto" placeholder="Asunto del mensaje">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <input type="date" value="<?php echo ($row_rs_producto['nombre_imagen']);?>" class="form-control" name="nombre_imagen" placeholder=" Fecha de peticion">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <input type="file" value="<?php echo ($row_rs_producto['ruta']);?>" class="form-control" name="ruta" placeholder=" Fecha de peticion">
                                                    </div>
                                                     
                                                    <div class="input-group mg-b-pro-edt">
                                                   
                                                    <input type="text" value="<?php echo ($row_rs_producto['id_catalogo']);?>" class="form-control" name="id_catalogo" placeholder=" Fecha de peticion">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Editar mensaje
														</button>
