...
<body>
  ...
  <div class="container-fluid">
    <div class="col-auto">
      ...
      <input required name="nombre" type="text" class="form-control mb-2" id="inlineFormInput" placeholder="&#129371;Ingrese el nombre del producto">  
      <input required name="tipo" type="text" class="form-control mb-2" id="inlineFormInput" placeholder="&#129472;Ingrese el tipo de producto"> 
      <input required name="descripccion" type="text" class="form-control mb-2" id="inlineFormInput" placeholder="&#128456;Ingrese la descripcion del prodcuto"> 
