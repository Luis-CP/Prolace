...
?>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" value="<?php echo ($row_rs_producto['id_usuario']);?>" class="form-control" name="id_usuario" placeholder="Nombre del mensaje: ejemplo@yahoo.com">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="text" value="<?php echo ($row_rs_producto['tipoProducto_pedido']);?>"class="form-control" name="tipoProducto_pedido" placeholder="Tipo pedido">
                                                    </div>
                                               
                                                  <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="number" value="<?php echo ($row_rs_producto['cantidad_pedido']);?>"class="form-control" name="cantidad_pedido" placeholder="Cantidad pedido">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <input type="date" value="<?php echo ($row_rs_producto['fechaRealizacion_pedido']);?>" class="form-control" name="fechaRealizacion_pedido" placeholder=" Fecha de peticion">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <input type="date" value="<?php echo ($row_rs_producto['fechaEntrega_pedido']);?>" class="form-control" name="fechaEntrega_pedido" placeholder=" Fecha de peticion">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <input type="text" value="<?php echo ($row_rs_producto['EstadoEntrega_pedido']);?>" class="form-control"   placeholder=" Fecha de peticion">
