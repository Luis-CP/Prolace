                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <center>  <ul id="myTab3" class="tab-review-design">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <input type="submit" onclick="alert(' Se guardo  campos editados');"class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="Guardar"> 
