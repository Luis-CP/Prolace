                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <?php
$query_rs_producto=sprintf("Select * from  mensaje_usuario where id_mensaje='%s'",$_GET['id']);
...
?>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" value="<?php echo ($row_rs_producto['nombre_mensaje']);?>" class="form-control" name="nombre_mensaje" placeholder="Nombre del mensaje: ejemplo@yahoo.com">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <input type="textarea" value="<?php echo ($row_rs_producto['asunto_mensaje']);?>"class="form-control" name="asunto_mensaje" placeholder="Asunto del mensaje">
                                                    </div>
                                               
                                                  
                                                    <div class="input-group mg-b-pro-edt">
                                                        <input type="date" value="<?php echo ($row_rs_producto['fechaDepeticion']);?>" class="form-control" name="fechaDepeticion" placeholder=" Fecha de peticion">
                                                    </div>
                                                      <div class="input-group mg-b-pro-edt">
                                                        <input type="hidden" class="form-control" value="<?php echo ($row_rs_producto['id_mensaje']);?>"0 name="id_mensaje" placeholder=" id">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Editar mensaje
                                                        ...
                                                        <td>&nbsp&nbsp&nbsp&nbsp&nbsp <a  onclick="alert('Pedido no eliminado');" href="panel_control.html" > <span class="glyphicon glyphicon-remove"  ></span>Cancelar</a></td>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
